$(function () {
    ...
    chatHub.client.newMessage = function (messageView) {
        ...
        $("#chat-panel")[0].scrollTo(0, Number.MAX_SAFE_INTEGER);
    ...
    chatHub.client.onGetNextRoomName = function (roomName) {
    ...
    Model.prototype = {
        ...
        createRoom: function (str) {
            var name = str || $("#roomName").val();
        ...
        getNextRoomName: function () {
            chatHub.server.getNextRoomName();
        },
    };
